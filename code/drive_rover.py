...
class RoverState():
    def __init__(self):
        ...
        self.rock_angles = None # Angles of sample rock  pixels
        ...
        self.stop_forward = 50 + 50# Threshold to initiate stopping
        self.go_forward = 500 + 50 # Threshold to go forward again
